...
def main():
    ...
    if choice == "1":
        ...
        print(fontstyle.apply("Welcome to the pig random password generation! This project creates random passwords for you based off YOUR choices! This project was a solo project done for my programming class in 2025. I had the experience of learning logic, how to use ascii and functions well.\n", "Italic"))
